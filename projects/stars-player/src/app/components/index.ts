...
export { PicKeyboardLayoutComponent } from "./layouts/pic-keyboard-layout/pic-keyboard-layout.component";
...
export { ButtonComponent } from './elements/button.component';
...
export { GraphemeKeyboardComponent } from './elements/grapheme-keyboard-component/grapheme-keyboard.component';
