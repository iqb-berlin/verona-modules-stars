...
import { InteractionButtonsEditorComponent } from './components/interaction-buttons-editor/interaction-buttons-editor.component';
...
import { InteractionFindOnImageEditorComponent } from './components/interaction-find-on-image-editor/interaction-find-on-image-editor.component';
import { InteractionVideoEditorComponent } from './components/interaction-video-editor/interaction-video-editor.component';
import { InteractionPolygonButtonsEditorComponent } from './components/interaction-polygon-buttons-editor/interaction-polygon-buttons-editor.component';
import { InteractionPlaceValueEditorComponent } from './components/interaction-place-value-editor/interaction-place-value-editor.component';
import { InteractionNumberLineEditorComponent } from './components/interaction-number-line-editor/interaction-number-line-editor.component';
import { InteractionPyramidEditorComponent } from './components/interaction-pyramid-editor/interaction-pyramid-editor.component';
import { InteractionEquationEditorComponent } from './components/interaction-equation-editor/interaction-equation-editor.component';
