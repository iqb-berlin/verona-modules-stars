...
export class StandardIconComponent {
  ...
  private renderIconHtml(iconKey: string, selected: boolean, hint: boolean): string {
    ...
    const baseStyle = `display: block; margin: auto; overflow: visible; ${shadowStyle}${hintStyle}`;
    ...
    switch (iconKey) {
      ...
      case 'SMILEY_1': {
        if (selected) {
          return `
            <svg width="124" height="124"  viewBox="0 0 124 124" fill="none" xmlns="http://www.w3.org/2000/svg" style="${baseStyle}">
        ...
        return `
          <svg width="130" height="130" viewBox="0 0 130 130" fill="none" xmlns="http://www.w3.org/2000/svg" style="${baseStyle}">
            <g>
